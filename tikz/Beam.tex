...
\begin{tikzpicture}[scale=1]
  ...
  \draw[ultra thick,red] (0,0) node[left] {$X_0$} -- (2,0) node[right] {$X_0+\delta X$};

  \draw[->] (0,0) -- (0,1) node[left] {$w(X_0)$};
  \draw[->] (2,0) -- (2,1.6) node[above] {$w(X_0+\delta X)$};
  \draw[ultra thick,blue] (0,1) -- (2,1.6);
  \node[below,blue] at (1,1) {$\theta$};
  \draw[dashed,thick,blue] (0,1) -- (2,1);
  \draw[blue, thick]
  ($(0,1)+(1,0)$) arc[start angle=0, end angle=15, radius=1];
