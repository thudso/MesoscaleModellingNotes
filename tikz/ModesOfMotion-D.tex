...
\begin{document}
  \begin{tikzpicture}
    ...
    \node (A) at (-1,-1) [inner sep=0pt] {};
    \node (B) at (+1,-1) [inner sep=0pt] {};
    \node (C) at (+1,+1) [inner sep=0pt] {};
    \node (D) at (-1,+1) [inner sep=0pt] {};
    \draw[thick] (A) rectangle (C);
    \begin{scope}[cm={sqrt(1+0.09),0.3,0.3,sqrt(1+0.09),(0,0)}]
      \draw[thick,dashed,blue] (-1,-1) rectangle (+1,+1);
    \end{scope}
  \end{tikzpicture}
\end{document}