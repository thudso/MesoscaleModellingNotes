...
\begin{tikzpicture}
  ...
  \foreach \r in {0.2, 0.4, 0.6, 0.8} {
    \pgfmathsetmacro{\rad}{\R*\r}
    \draw[dotted] (0,0) circle (\rad);
    \foreach \angle in {0,30,60,90,120,150,180,210,240,270,300,330} {
      % Position on circle
      \coordinate (P) at (\angle:\rad);
      \pgfmathsetmacro{\dx}{0.7*\rad*(1-\r)/2}
      % Draw an arrow tangent to the circle (90° ahead of radius)
      \draw[->, thick, red] (P) -- ++(\angle-90:\dx);
    }
  }
\end{tikzpicture}
\end{document}