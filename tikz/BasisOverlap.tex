...
\begin{tikzpicture}
  ...
  % N_0
  \draw[red, thick] (0, 2) node[above right] {$N_{1}$} -- (2,0);
  \draw[dashed] (0, 2) -- (0, 0);
  
  % N_1
  \draw[brown, thick] (0, 0) -- (2, 2) node[above] {$N_{1}$} -- (4,0);
  \draw[dashed] (2, 2) -- (2, 0);
  
  % N_2
  \draw[blue, thick] (2, 0) -- (4, 2) node[above] {$N_2$} -- (6,0);
  \draw[dashed] (4, 0) -- (4, 2);

  % N_3
  \draw[orange, thick] (4, 0) -- (6, 2) node[above] {$N_3$};
  \draw[dashed] (6, 0) -- (6, 2);
\end{tikzpicture}
\end{document}