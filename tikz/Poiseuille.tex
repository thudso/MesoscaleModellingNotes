...
\begin{tikzpicture}
  ...
  \draw[thick,->] (0,-2) -- (0,2.2) node[left] {$y$};
  
  \draw[domain=-1.8:1.8, samples=100] plot ({(1.8*1.8-\x*\x)/2}, {\x});
  
  \foreach \y in {-1.6, -1.2, -0.8, -0.4, 0.0, 0.4, 0.8, 1.2, 1.6} {
    \draw[thick,->] (0,\y) -- ({(1.8*1.8-\y*\y)/2},\y);
  }

  \draw[ultra thick,gray] (-0.5,1.8) -- (2,1.8);
  \draw[ultra thick,gray] (-0.5,-1.8) -- (2,-1.8);
\end{tikzpicture}
\end{document}