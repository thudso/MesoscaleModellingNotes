...
\begin{document}
  \begin{tikzpicture}
    ...
    \draw[very thick,->] (1,0) -- (1.5,0.4) node[label={[xshift=9pt,yshift=-3pt]above:$(S_{11},S_{21})$}] {};
    \draw[very thick,->] (-1,0) -- (-1.5,-0.4);
    \draw[very thick,->] (0,1) -- (0.4,1.7) node[above] {$(S_{12},S_{22})$};
    \draw[very thick,->] (0,-1) -- (-0.4,-1.7);
  \end{tikzpicture}
\end{document}